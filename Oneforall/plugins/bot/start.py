    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker(
                "CAACAgUAAxkBAAIFNmkDFeXbDpHW7ToSHKNRKwziMqjLAAIxFQACu-sRV290bJdUHfc5HgQ"
            )
        ...
        for member in message.new_chat_members:
            ...
            if isinstance(config.OWNER_ID, int): 
                if member.id == config.OWNER_ID:
                    owner = f"#BOT_OWNER\n\n 𝙎𝙩𝙖𝙮 𝘼𝙡𝙚𝙧𝙩 ⚠️\n\n{member.mention} 𝙊𝙬𝙣𝙚𝙧 𝗢𝗳 {app.mention} 𝙟𝙪𝙨𝙩 𝙟𝙤𝙞𝙣𝙚𝙙 𝙩𝙝𝙚 𝙜𝙧𝙤𝙪𝙥 <code>{message.chat.title}</code>.\n\n𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗠𝗲 𝗛𝗲𝗿𝗲 👇🏻💗🥀\n\n┏━━━━━━━━━━━━┓\n┣★ 𝗨𝗽𝗱𝗮𝘁𝗲 -: @NOB1TA_SUPPORT  \n┣★ 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 -: @OG_DEFAULTERS_2016  \n┣★ 𝗕𝗼𝘁 𝗨𝘀𝗲𝗿𝗡𝗮𝗺𝗲 -: @{app.username}\n┣★ 2𝗻𝗱 𝗠𝘂𝘀𝗶𝗰 𝗕𝗼𝘁 -: @NOBITA_MUSIC_TG_BOT  \n┣★ 3𝗿𝗱 𝗠𝘂𝘀𝗶𝗰 𝗕𝗼𝘁 -: @VanshikaMusicRobot  \n┣★ 4𝘁𝗵 𝗠𝘂𝘀𝗶𝗰 𝗕𝗼𝘁 -: @RavanMusicBot  \n┣★ 𝗠𝘆 𝗢𝘄𝗻𝗲𝗿 -: @ll_NOBITA_DEFAULTERS_ll   </code>\n┣★ 𝙉𝙤𝙩𝙚  -: 𝗧𝗵𝗶𝘀 𝗜𝘀 𝗢𝗻𝗹𝘆 𝗙𝗼𝗿 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗙𝗼𝗿 𝗠𝘆 𝗢𝘄𝗻𝗲𝗿 {member.mention}."
            ...
            if isinstance(SUDOERS, int): 
                if member.id == SUDOERS:
                    AMBOT = f"#Sudo_User\n\n 𝙎𝙩𝙖𝙮 𝘼𝙡𝙚𝙧𝙩 ⚠️\n\n𝗢𝗙 {app.mention} 𝗦𝗨𝗗𝗢 𝗨𝗦𝗘𝗥 {member.mention} just joined the group <code>{message.chat.title}</code>.\n\n𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗠𝗲 𝗛𝗲𝗿𝗲 👇🏻🤭💕\n\n┏━━━━━━━━━━━━┓\n┣★ 𝗨𝗽𝗱𝗮𝘁𝗲 -: @NOB1TA_SUPPORT   \n┣★ 𝗨𝗽𝗱𝗮𝘁𝗲 -: @NOB1TA_SUPPORT  \n┣★ 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 -: @NOB1TA_SUPPORT  \n┣★ 𝗕𝗼𝘁 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘 -: @{app.username}\n┣★ 𝗦𝘂𝗽𝗲𝗿𝗯𝗮𝗻 𝗟𝗼𝗴𝘀 -: @NOB1TA_SUPPORT \n┣★ 𝓐𝓫𝓸𝓾𝓽 𝓐𝓶𝓑𝓸𝓽 -: @NOB1TA_SUPPORT \n┣★ 𝗳𝗲𝗱𝗲𝗿𝗮𝘁𝗶𝗼𝗻𝘀 𝗝𝗼𝗶𝗻 𝗛𝗲𝗿𝗲 -:<code>@NOB1TA_SUPPORT  </code>."
                ...
                if member.id in SUDOERS:
                    AMBOT = f"#Sudo_User\n\n 𝙎𝙩𝙖𝙮 𝘼𝙡𝙚𝙧𝙩 ⚠️\n\n𝗢𝗙 {app.mention} 𝗦𝗨𝗗𝗢 𝗨𝗦𝗘𝗥 {member.mention} just joined the group <code>{message.chat.title}</code>.\n\n𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗠𝗲 𝗛𝗘𝗥𝗘 👇🏻🤭💕\n\n┏━━━━━━━━━━━━┓\n┣★ 𝗨𝗽𝗱𝗮𝘁𝗲 -: @NOB1TA_SUPPORT   \n┣★ 𝗨𝗽𝗱𝗮𝘁𝗲 -: @NOB1TA_SUPPORT  \n┣★ 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 -: @NOB1TA_SUPPORT  \n┣★ 𝗕𝗢𝗧 𝗨𝗦𝗘𝗥𝗡𝗔𝗠𝗘 -: @{app.username}\n┣★ 𝗦𝘂𝗽𝗲𝗿𝗕𝗮𝗻 𝗟𝗢𝗚𝗦 -: @NOB1TA_SUPPORT\n┣★ ONE FOR ALL -: @NOB1TA_SUPPORT \n┣★ 𝗳𝗲𝗱𝗲𝗿𝗮𝘁𝗶𝗼𝗻𝘀 𝗝𝗼𝗶𝗻 𝗛𝗲𝗿𝗲 -:<code>@NOB1TA_SUPPORT </code>."
                    sent_message = await message.reply_text(AMBOT, reply_markup=buttons)
                    await asyncio.sleep(60)
                    await sent_message.delete()  
                    return
