...
def load_fonts():
    try:
        return {
            "cfont": ImageFont.truetype("Oneforall/assets/cfont.ttf", 24),
            "tfont": ImageFont.truetype("Oneforall/assets/font.ttf", 30),
        }
...
FALLBACK_IMAGE_PATH = "Oneforall/assets/controller.png"
...
async def add_controls(img: Image.Image) -> Image.Image:
    ...
    region = img.crop(box)
    try:
        controls = Image.open("Oneforall/assets/controls.png").convert("RGBA")
