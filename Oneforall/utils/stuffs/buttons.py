...
class BUTTONS(object):
    MBUTTON = [
        [
            InlineKeyboardButton("⚘ Cʜᴀᴛ-Gᴘᴛ ➻", callback_data="mplus HELP_ChatGPT"),
        ...
        [
            InlineKeyboardButton("⚘ Cᴏᴜᴘʟᴇꜱ ➻", callback_data="mplus HELP_Couples"),
        ...
        [
            ...
            InlineKeyboardButton("⚘ Qᴜᴏᴛʟʏ ➻", callback_data="mplus HELP_Q"),
        ],
        [
